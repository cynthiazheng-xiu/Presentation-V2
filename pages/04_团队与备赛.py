...
with col_t1:
    st.markdown("""
    <div style="background-color: #1e5f7a; color: white; padding: 1rem; border-radius: 10px; text-align: center; height: 310px;">
...
st.info("🏆 **指导教师战绩**：近三年累计获得贵州省教育厅颁发的省级技能大赛奖项6项，其中一等奖2项，二等奖4项。多次荣获学院“优秀教师”称号（2021、2022、2024）。")
