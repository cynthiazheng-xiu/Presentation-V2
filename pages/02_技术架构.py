...
with col_ai:
    st.markdown("""
    <div style="background: linear-gradient(145deg, #e1f0f7, #ffffff); padding: 1.5rem; border-radius: 15px; border: 2px solid #1e5f7a; height: 420px; display: flex; flex-direction: column;">
...
with col_plus:
    st.markdown("<h1 style='text-align: center; color: #f3b33d; font-size: 3rem; margin-top: 170px;'>+</h1>", unsafe_allow_html=True)

with col_digital:
    st.markdown("""
    <div style="background: linear-gradient(145deg, #fef9e9, #ffffff); padding: 1.5rem; border-radius: 15px; border: 2px solid #f3b33d; height: 420px; display: flex; flex-direction: column;">
...
<div style="text-align: center; color: #7a8e99; font-size: 0.9rem; padding: 1rem;">
    ⚡ 本页面展示了“极速出海”的核心技术架构 | 左右模块高度一致，体现平衡设计
</div>
""", unsafe_allow_html=True)
